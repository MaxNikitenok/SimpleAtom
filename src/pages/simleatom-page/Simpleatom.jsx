  ...
  return (
    <main className={styles.simpleatom}>
      ...
      <h1 className={styles.simpleatom__description}>
        ...
        <br /> is a <span>software development</span> company specializing{' '}
      ...
      <section ref={sectionOneRef} className={styles.section2}>
        ...
        <FirstSlider conservativeRef={conservativeRef}  />
      </section>
      ...
      <div className={styles.switch_wrapper}>
        <div className={styles.switch}>
          <div
            className={isConservative ? styles.switch_button : styles.grey_text}
          ...
          |
          <div
            className={isConservative ? styles.grey_text : styles.switch_button}
            onClick={() => setConservative(false)}
          >
            “Medium-volatility”(ATOM)
          </div>
        </div>
        <div className={isConservative ? styles.switch_content_2 : styles.hide}>
          <section className={styles.graph2} ref={conservativeRef}>
            <div className={styles.graph2__big_container}>
              ...
              <div ref={graphTwoRef} className={styles.graph2__top_container}>
              ...
              <div className={styles.graph2__text_container}>
                <div className={styles.graph2__text}>
                  ...
                  <div className={styles.graph2__text_right_side}>
                    <p>
                      Best solution for large capital (family funds, asset
                      managers) with a stable grow
                    </p>
        ...
        <div className={isConservative ? styles.hide : styles.switch_content_2}>
          <section className={styles.graph1}>
            <div className={styles.graph1__big_container}>
              ...
              <div ref={graphOneRef} className={styles.graph1__top_container}>
              ...
              <div className={styles.graph1__text_container}>
                <div className={styles.graph1__text}>
                  ...
                  <div className={styles.graph1__text_right_side}>
                    <p>
                      Best solution for individuals for quick investments
                      multiply
                    </p>
